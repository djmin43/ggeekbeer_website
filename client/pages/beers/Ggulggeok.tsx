...
const Ggulggeok = () => {
    return (
        ...
        <Grid  container>
                ...
                <p>'꿀꺽'은 라거 맥주로, 맥주의 많은 매력들 중 '다가가기 쉬움'과 '마시기 편함'을 잘 보여주는 스타일입니다. 우리는 여기에 중점을 두고 '홉'의 개성을 부드럽게 살려주고자 노력했습니다.</p>
                <p>편안하게 다가가면서 메인 스트림과 다른 크래프트 맥주의 매력을 소개하고 싶었습니다. 크래프트 맥주를 좋아하는 사람들, 처음 접하게 될 사람들 간의 경계를 허물고 모두 즐길 수 있는 술이 되길 바랍니다.</p>
                </Grid>
        </Grid>
        </div>
