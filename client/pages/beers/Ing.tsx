...
const Ing = () => {
    return (
        ...
        <Grid  container>
                ...
                <h3>'잉'은 New England IPA 스타일의 맥주로, 뉴잉, 혹은 NEW IPA라고 부르는 이 스타일은 IPA가 가지는 홉의 과일, 꽃과 같은 긍정적인 향이 극대화되어 터져나오며 적절한 단 맛과 조화를 이루는 juice같은 맥주입니다. 사용된 홉의 양과 질감을 살리기 위해 들어간 귀리, 밀 등의 재료로 인하여 다소 혼탁한 외관을 가집니다.</h3>
                <h3>'홉'IPA를 만들며 설명드린 바와 같이 홉 종들은 저마다 특유의 향을 가지고 있으며 우리는 재미잇는 콤보와 적절한 밸런스를 찾아 여러분과 공유하려고 합니다.</h3>
                </Grid>
        </Grid>
        </div>
